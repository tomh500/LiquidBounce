        ...
        {#if c.settings.enabled}
            ...
            >
                ...
                {:else if c.name === "ClosedCaptions"}
                    <ClosedCaptions/>
                {:else if ["RikkaMusic", "MusicLyrics", "MusicActionbarLyrics", "MusicDynamicIsland"].includes(c.name)}
                    <div class="native-component-label">{c.name === "RikkaMusic" ? "Music Info" : c.name === "MusicLyrics" ? "Music Lyrics" : c.name === "MusicActionbarLyrics" ? "ActionBar Lyrics" : "Music Dynamic Island"}</div>
