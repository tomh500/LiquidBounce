<script lang="ts">
    ...
    $: songs = view === "search" ? searchResults : view === "cloud" ? cloudSongs : selected?.songs ?? [];
    ...
    async function runSearch() {
        ...
        try { view = "search"; searchTab = "综合"; searchResults = await searchRikkaMusic(search.trim()); error = ""; }
