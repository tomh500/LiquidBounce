...
public class CloudMusicClient {
    ...
    /**
     * Initializes the merged CloudMusic module as part of the LiquidBounce client.
     * Called from the client entry point after malilib has been booted.
     */
