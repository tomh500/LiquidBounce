...
public class CacheHelper {
    ...
    public void printToChatHud(FabricClientCommandSource source) {
        source.sendFeedback(Component.translatable("cloudmusic.info.config.cache", "§c" + this.useMb, "§c" + this.maxMb, "§c" + this.deleteMb));
        source.sendFeedback(Component.translatable("cloudmusic.info.config.cache.path", "§c" + this.cachePath));
    }
}
