...
public class StyleTag extends Music163Obj implements IPrint {
    ...
    public void printToChatHud(FabricClientCommandSource source) {
        ...
        source.sendFeedback(Component.literal(this.name + " - " + this.enName));

        source.sendFeedback(Component.literal(""));

        source.sendFeedback(Component.translatable("cloudmusic.info.style.music.count", this.songNum));
        source.sendFeedback(Component.translatable("cloudmusic.info.style.artist.count", this.artistNum));
        source.sendFeedback(Component.literal("§7" + this.desc));
        ...
        if (this.tagPortrait != null){
            ...
            source.sendFeedback(Component.literal(templateContents[2]));
        }
