 ...
 */
@ApiStatus.Internal
public class TimeFmtDayAmPm extends TimeFmt
{
    private final DateTimeFormatter formatter;

    public TimeFmtDayAmPm(TimeFormat fmt)
    {
        super(fmt);
        this.formatter = DateTimeFormatter.ofPattern("EEE, hh:mm a", Locale.ROOT);
        this.formatString = "EEE, hh:mm a";
    }
