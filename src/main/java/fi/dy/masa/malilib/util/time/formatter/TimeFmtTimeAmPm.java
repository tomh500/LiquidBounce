 ...
 */
@ApiStatus.Internal
public class TimeFmtTimeAmPm extends TimeFmt
{
    private final DateTimeFormatter formatter;

    public TimeFmtTimeAmPm(TimeFormat fmt)
    {
        super(fmt);
        this.formatter = DateTimeFormatter.ofPattern("hh:mm a", Locale.ROOT);
        this.formatString = "hh:mm a";
    }
