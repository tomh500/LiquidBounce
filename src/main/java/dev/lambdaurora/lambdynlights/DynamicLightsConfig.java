...
public class DynamicLightsConfig {
	...
	private void copyDefaultFile() throws IOException {
		...
		try (var input = DynamicLightsConfig.class.getResourceAsStream("/lambdynlights.toml")) {
			if (input == null) throw new IllegalStateException("Missing integrated dynamic lights configuration.");
			Files.copy(input, CONFIG_FILE_PATH, StandardCopyOption.REPLACE_EXISTING);
		}
